...
map.getView().fit([-384348.230186, 5240839.685036, -201472.490212, 5388762.334615], map.getSize());
map.getView().setCenter(ol.proj.fromLonLat([-2.9, 43.2]));
